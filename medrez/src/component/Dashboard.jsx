        ...
        <div className="flex">
          <div className="w-[70%] p-5">
            <div className="p-5 flex flex-col gap-5 bg-white rounded-lg shadow-md">
              ...
              <div className="bg-gray-50 p-10 rounded-lg shadow-md space-y-6">
  <div className="flex justify-end space-x-2">
    <button
      className="text-white font-semibold bg-blue-600 py-2 px-6 rounded-lg hover:bg-blue-700 transition duration-200 flex items-center gap-1"
      ...
      <table className="min-w-full bg-white rounded-lg shadow-md">
        <thead>
          <tr className="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
            <th className="p-4 border-b font-semibold text-left">Schedule Name</th>
            <th className="p-4 border-b font-semibold text-left">Actions</th>
          </tr>
        </thead>
        <tbody className="text-gray-700 divide-y">
          {annualRotationData.map((schedule) => (
            <tr key={schedule._id} className="hover:bg-gray-50 transition duration-200">
              <td className="p-4">{schedule.scheduleName}</td>
              <td className="p-4 flex items-center space-x-2">
                <button
                  className="bg-blue-600 text-white font-semibold py-1 px-3 rounded-lg hover:bg-blue-700 transition duration-200"
