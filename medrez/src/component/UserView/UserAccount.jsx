...
function UserAccount() {
  return (
    <UserLayout className="p-8 overflow-y-scroll h-screen bg-gray-100">
      <div className="p-8 overflow-y-scroll h-screen bg-gray-100">
          ...
          <div className="border-2 border-dotted border-gray-400 p-4 mb-4">
            ...
            <p>
              ...
              <span className="font-semibold">
                Jun 24th, 2024 to Jul 6th, 2025
              </span>
            </p>
            <p>
              Ordered on:{" "}
              <span className="font-semibold">Sep 10th, 2024</span>
            </p>
            <p>
              using <span className="text-blue-600 underline">Credit Card</span>
            </p>
        ...
        <div className="border-2 border-gray-300 rounded-md p-6 mb-6">
          ...
          <p>
            Allowed dates:{" "}
            <span className="font-semibold">Sep 1st, 2024 to Nov 2nd, 2024</span>
          </p>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-yellow-100 p-4 rounded-md">
            ...
            <p>
              <span className="font-semibold">Email:</span> support@MedRez.net
            </p>
